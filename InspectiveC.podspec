#
#  Be sure to run `pod spec lint InspectiveC.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "InspectiveC"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of InspectiveC."
  ...
  spec.homepage     = "https://github.com/tony0x59/InspectiveC"
  ...
  spec.author             = { "tony0x59" => "hanningkong@gmail.com" }
  # Or just: spec.author    = "tony0x59"
  # spec.authors            = { "tony0x59" => "hanningkong@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/tony0x59"
  ...
  spec.source       = { :git => "https://github.com/tony0x59/InspectiveC.git", :tag => "#{spec.version}" }
